...
CREATE TABLE `tb_message` (
  ...
  `ipsAccount` DECIMAL (12, 2) NULL COMMENT 'ips账号',
  `redPacketNum` INT (11) NULL COMMENT '红包数',
  `availableRemain` DECIMAL (11) NULL COMMENT '可用余额',
  `frozenRemain` DECIMAL (11) NULL COMMENT '冻结金额',
  `points` INT(11) DEFAULT  0 COMMENT  '积分',
  `recomReaward` DECIMAL DEFAULT  0 COMMENT '推荐奖励',
